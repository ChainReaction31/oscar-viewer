...
import {SelectedEventOcc, Comment, SelectedEvent} from "types/new-types";
...
export default function AddComment(props: {
  ...
  const handleSubmit = () =>{
    ...
    const newComment: Comment ={
        occupancyId: props.event.occupancyId,
        laneName: props.event.laneId,
        user: user,
        vehicleId: vehicleId,
        notes: notes,
        files: uploadedFiles,
  ...
  return (
    <Stack direction={"column"} p={2} spacing={2}>
      ...
      <Stack direction={"row"} spacing={2} justifyContent={"start"} alignItems={"center"}>
        ...
        <Stack direction={"row"} spacing={2} justifyContent={"start"} alignItems={"center"}>
            <AdjudicationSelect value={adjudicated} onSelect={handleAdjudicationSelect} />
